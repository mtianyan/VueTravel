    ...
    <div>
      ...
      <div class="list-item">
        ...
        <div class="item-wrapper">
          <div class="item" v-for="item in hotCities" :key="item.id" @click="handleCityChange(item.name)">{{item.name}}
          </div>
        </div>
      </div>
      <div class="list-item alphabet">
        ...
        <div class="item-wrapper">
          <div class="item" v-for="item in alphabet" :key="item" @click="letter(item)">{{item}}</div>
        </div>
      </div>
      <div class="list-item city" v-for="(item, index) in cities" :key="index" :ref="index">
  ...
  methods: {
    ...
    letter (index) {
      if (index) {
        ...
        console.log(element)
        this.scroll.scrollToElement(element) // TODO: 滚动不生效
      }
    },
